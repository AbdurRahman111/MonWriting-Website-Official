...
def start():
    ...
    scheduler.add_job(execute_save_trends_news_everyday, 'cron', day_of_week='mon-sun', hour=6, minute=0)
    scheduler.add_job(execute_save_trends_news_everyday, 'cron', day_of_week='mon-sun', hour=12, minute=0)
    scheduler.add_job(execute_save_trends_news_everyday, 'cron', day_of_week='mon-sun', hour=18, minute=0)
    scheduler.add_job(execute_save_trends_news_everyday, 'cron', day_of_week='mon-sun', hour=0, minute=0)
    scheduler.start()
