...
def start():
    ...
    scheduler.add_job(execute_save_trends_news_everyday, 'cron', day_of_week='mon-sun', hour=22, minute=0)
    scheduler.add_job(execute_save_trends_news_everyday, 'cron', day_of_week='mon-sun', hour=2, minute=0)
    scheduler.start()
